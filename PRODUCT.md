...
Corey 本人(独立开发者,主力工具 Claude Code 与 Codex,中文为主)。已开源(2026-08-18 v0.1.0 首发,当前 v0.2.10 2026-08-26,github.com/iAmCorey/Wake,MIT):面向同时使用多个 coding agent 的开发者。
